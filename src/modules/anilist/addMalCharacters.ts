...
registerModule.anilist({
	...
	async load({ media }) {
		try {
			...
			// Would have prefered this being it's own module but this needs to happen
			// after the MAL characters module and this is the only way currently that
			// I can assure this happens afterwards.
			// Might make some kind of priority/require system later to allow modules
			// to hold their execution until another specified module has loaded.
